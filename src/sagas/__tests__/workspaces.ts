...
describe('EVAL_EDITOR', () => {
  test.skip('puts beginClearContext and correctly executes prepend and value in sequence (calls evalCode)', () => {
...
describe('TOGGLE_EDITOR_AUTORUN', () => {
  test.skip('calls showWarningMessage correctly when isEditorAutorun set to false', () => {
  ...
  test.skip('calls showWarningMessage correctly when isEditorAutorun set to true', () => {
...
describe('INVALID_EDITOR_SESSION_ID', () => {
  test.skip('calls showWarningMessage correctly', () => {
    return expectSaga(workspaceSaga)
...
describe('EVAL_REPL', () => {
  test.skip('puts beginInterruptExecution, clearReplInput, sendReplInputToOutput and calls evalCode correctly', () => {
    const workspaceLocation = WorkspaceLocations.playground;
...
describe('DEBUG_RESUME', () => {
  ...
  test.skip('puts beginInterruptExecution, clearReplOutput, highlightEditorLine and calls evalCode correctly', () => {
...
describe('DEBUG_RESET', () => {
  test.skip('puts clearReplOutput correctly', () => {
    const workspaceLocation = WorkspaceLocations.assessment;
...
describe('EVAL_TESTCASE', () => {
  test.skip('correctly executes prepend, value, postpend, testcase in sequence (calls evalTestCode)', () => {
    const workspaceLocation = WorkspaceLocations.grading;
...
describe('CHAPTER_SELECT', () => {
  ...
  test.skip('puts beginClearContext, clearReplOutput and calls showSuccessMessage correctly', () => {
    const newChapter = 3;
  ...
  test.skip('does not call beginClearContext, clearReplOutput and showSuccessMessage when oldChapter === newChapter', () => {
    const newChapter = 4;
    const library: Library = {
      chapter: newChapter,
      external: {
...
describe('PLAYGROUND_EXTERNAL_SELECT', () => {
  ...
  test.skip('puts changeExternalLibrary, beginClearContext, clearReplOutput and calls showSuccessMessage correctly', () => {
  ...
  test.skip('does not call the above when oldExternalLibraryName === newExternalLibraryName', () => {
...
describe('ENSURE_LIBRARIES_LOADED', () => {
  test.skip('does not call showWarningMessage when getReadyWebGLForCanvas is not undefined', () => {
  ...
  test.skip('calls showWarningMessage when race condition timeouts', () => {
    return expectSaga(workspaceSaga)
      .provide({
        race: () => ({
...
describe('BEGIN_CLEAR_CONTEXT', () => {
  ...
  test.skip('loads RUNES library correctly', () => {
    const newExternalLibraryName = ExternalLibraryNames.RUNES;
  ...
  test.skip('loads CURVES library correctly', () => {
...
describe('evalCode', () => {
  ...
  describe('on EVAL_EDITOR action without interruptions or pausing', () => {
    test.skip('calls runInContext, puts evalInterpreterSuccess when runInContext returns finished', () => {
    ...
    test.skip('does not put evalTestcase (assessment has testcases and Autograder tab is inactive)', () => {
      state = generateDefaultState(workspaceLocation, {
    ...
    test.skip('puts evalTestcase (assessment has testcases and Autograder tab is active)', () => {
      const type = 'result';
    ...
    test.skip('prematurely terminates if execution of one testcase results in an error', () => {
      const type = 'error';
    ...
    test.skip('puts evalTestcase (submission has testcases and Autograder tab is active)', () => {
      const type = 'result';
      workspaceLocation = WorkspaceLocations.grading;
      state = generateDefaultState(workspaceLocation, {
    ...
    test.skip('calls runInContext, puts endDebuggerPause and evalInterpreterSuccess when runInContext returns suspended', () => {
      return expectSaga(evalCode, code, context, execTime, workspaceLocation, actionType)
        .withState(state)
    ...
    test.skip('calls runInContext, puts evalInterpreterError when runInContext returns error', () => {
      return expectSaga(evalCode, code, context, execTime, workspaceLocation, actionType)
        .withState(state)
        .call(runInContext, code, context, {
          scheduler: 'preemptive',
    ...
    test.skip('with error in the code, should return correct line number in error', () => {
      code = '// Prepend\n error';
  ...
  describe('on DEBUG_RESUME action without interruptions or pausing', () => {
    ...
    test.skip('calls resume, puts evalInterpreterSuccess when resume returns finished', () => {
    ...
    test.skip('calls resume, puts endDebuggerPause and evalInterpreterSuccess when resume returns suspended', () => {
      actionType = actionTypes.DEBUG_RESUME;
    ...
    test.skip('calls resume, puts evalInterpreterError when resume returns error', () => {
      actionType = actionTypes.DEBUG_RESUME;
  ...
  describe('on interrupt', () => {
    test.skip('puts debuggerReset, endInterruptExecution and calls showWarningMessage', () => {
      return expectSaga(evalCode, code, context, execTime, workspaceLocation, actionType)
        .withState(state)
        .provide({
          race: () => ({
  ...
  describe('on paused', () => {
    test.skip('puts endDebuggerPause and calls showWarningMessage', () => {
      return expectSaga(evalCode, code, context, execTime, workspaceLocation, actionType)
        .withState(state)
        .provide({
          race: () => ({
...
describe('evalTestCode', () => {
  ...
  describe('without interrupt', () => {
    test.skip('puts evalInterpreterSuccess and evalTestcaseSuccess on finished status', () => {
    ...
    test.skip('puts additional clearReplOutputLast for hidden testcases after finished status', () => {
    ...
    test.skip('puts evalInterpreterError and evalTestcaseFailure on error status', () => {
      return expectSaga(evalTestCode, code, context, execTime, workspaceLocation, index, type)
        .withState(state)
    ...
    test.skip('puts additional clearReplOutputLast for hidden testcases after error status', () => {
      type = TestcaseTypes.hidden;
  ...
  describe('on interrupt', () => {
    test.skip('puts endInterruptExecution and calls showWarningMessage', () => {
